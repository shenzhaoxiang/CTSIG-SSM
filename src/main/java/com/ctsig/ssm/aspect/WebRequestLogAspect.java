//package com.ctsig.ssm.aspect;
//
//import com.ctsig.ipx.domain.log.OperatorLog;
//import com.ctsig.ipx.service.OptLogService;
...
//
//    @Pointcut("execution(public * com.ctsig.*.web..*.*(..))")
...
//            optLog.setResult(gson.toJson(result));
...
//                Object jsonObj = JSON.serialize(paramsArray[i]);
